...
public class SeasonalDiseasesInfoViewer extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seasonal_diseases_info_viewer);
        textViewDiseaseName = findViewById(R.id.ID_SeasonalDiseasesInfoViewer_DiseaseName_ET);
        textViewDiseaseInfo = findViewById(R.id.ID_SeasonalDiseasesInfoViewer_DiseaseInfo_ET);
        imageViewTextToSpeech = findViewById(R.id.ID_SeasonalDiseasesInfoViewer_TextToSpeech_IV);
        currentUserId = getIntent().getStringExtra("id");
        disease_pos = getIntent().getIntExtra("disease_pos", 0);
        diseaseName = getResources().getStringArray(R.array.seasonal_disease_name);
        diseaseInfo = getResources().getStringArray(R.array.seasonal_disease_info);
