...
public class HomePage extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.ID_Options_ContactUs) {
            Intent intent = new Intent(HomePage.this, AboutUs.class);
            intent.putExtra("id", currentUserId);
            startActivity(intent);
        }
        if (item.getItemId() == R.id.ID_Options_AboutUs) {
            Intent intent = new Intent(HomePage.this, AppIntroduction.class);
            intent.putExtra("id", currentUserId);
            startActivity(intent);
        }
        if (item.getItemId() == R.id.ID_Options_FAQ) {
            Intent intent = new Intent(HomePage.this, FAQ.class);
            intent.putExtra("id", currentUserId);
            startActivity(intent);
        }
    ...
    public void onFlashCardFunctionality(View view) {
        Intent intent=new Intent(HomePage.this,FlashCardFunctionality.class);
        startActivity(intent);
    }

    public void onGovernmentHealthSchemes(View view) {
        Intent intent=new Intent(HomePage.this,GovernmentHealthSchemesList.class);
        startActivity(intent);
    }

    public void onDonorAndDonee(View view) {
        Intent intent=new Intent(HomePage.this,DonorAndDonee.class);
        startActivity(intent);
    }

    public void onMedicineSearch(View view) {
        Intent intent=new Intent(HomePage.this,MedicineSearch.class);
        startActivity(intent);
    }

    public void onSeasonalDiseases(View view) {
        Intent intent=new Intent(HomePage.this,SeasonalDiseases.class);
        startActivity(intent);
    }
}
